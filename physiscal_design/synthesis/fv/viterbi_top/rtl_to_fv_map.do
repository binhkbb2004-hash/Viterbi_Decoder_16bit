...
# Generated on: Thu May 14 15:51:07 +07 2026 (Thu May 14 08:51:07 UTC 2026)
...
set logfile fv/viterbi_top/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/viterbi_top -revised fv_map -use_rtl_names
...
read_library -liberty -both \
    /home/iclab16/Desktop/viterbi_binh/synthesis/../lib/sky130_ss_1.62_125_nldm.lib
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k ../rtl/extract_bit.v ../rtl/branch_metric.v ../rtl/add_comp_slt.v ../rtl/memory.v ../rtl/traceback.v ../rtl/viterbi_top.v
elaborate_design -golden -root {viterbi_top} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/viterbi_top/fv_map.v.gz
elaborate_design -revised -root {viterbi_top}
...
set_analyze_option -mapping_file fv/viterbi_top/fv_map.map.do
...
set_system_mode lec
write_compared_points noneq.compared_points.viterbi_top.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.viterbi_top.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.viterbi_top.rtl.fv_map.rpt
