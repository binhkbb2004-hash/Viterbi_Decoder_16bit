module traceback (
    ...
    input  wire [1:0] i_slt_node, // Điểm bắt đầu được gửi từ ACS
    ...
    reg       is_tracing;    // Cờ báo hiệu mạch đang chạy

    // Bộ MUX chọn tráng thái liền trước 
    reg [1:0] target_node; 
    reg [1:0] next_node;
    always @(i_memory_done, i_slt_node, current_node, i_bck_prev_st_00, i_bck_prev_st_01, i_bck_prev_st_10, i_bck_prev_st_11) begin 
        // Chu kì đầu tiên chọn node theo slt_node được gửi từ ACS        
        if (i_memory_done == 1'b1) begin
            target_node = i_slt_node;
        end 
        else begin
        ...
        // Chọn node tiếp theo 
        case (target_node)
            2'b00:   next_node = i_bck_prev_st_00;
            2'b01:   next_node = i_bck_prev_st_01;
            2'b10:   next_node = i_bck_prev_st_10;
            2'b11:   next_node = i_bck_prev_st_11;
